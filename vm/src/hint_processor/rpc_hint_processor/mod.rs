...
impl RpcHintProcessor {
    pub fn new(inner_processor: Cairo1HintProcessor, server: Option<String>) -> Self {
        Self { inner_processor, server }
    }
...
impl HintProcessorLogic for RpcHintProcessor {
    ...
    fn execute_hint(
        ...
        _constants: &std::collections::HashMap<String, starknet_types_core::felt::Felt>,
